...
def get_path():
    ...
    path = r'C:\Users' + f'\\{EMPIRICA_USER}' + r'\Empírica Investimentos Gestão de Recursos Ltda\Dados - Documentos\Empirica Cobrancas e Garantias\5 - Avaliacoes de Imoveis\Laudos Creditas' + time_folder    
